...
args['east']="/Users/surajmenon/Desktop/findocDocs/frozen_east_text_detection2.pb"
#args['min_confidence'] = 1e-3 #TODO: tune this
args['min_confidence'] = .999
...
r_image, results = process_image(True, image_to_process, args['east'], args['min_confidence'], args['width'], args['height'])
